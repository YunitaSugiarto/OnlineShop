...
this.setState({
  ...
  removeFromCart = (products) => {
    ...
    let cart = carts.filter(item => item.id_products !== products.id_products );
        ...
        <div className="col-md-4 order-md-2 mb-4">
         ...
         :
          ...
          <div className="col-md-4 order-md-2 mb-4">
            ...
            <ul className="list-group mb-3">
                <div>{carts.map((products, index) =>
                  <div key={index}>
                    <li className="list-group-item d-flex justify-content-between lh-condensed">
                      <div>
                        <h4 className="text-capitalize font-weight-bold">{products.name}</h4>
                      </div>
                      
                      <h5><span className="badge badge-secondary">{products.qty}</span></h5>

                      <h5>
                  <span className="badge badge-secondary">Rp. {products.total}</span>
                  </h5>
                      <button className="btn btn-sm btn-warning"
                        onClick={() => this.removeFromCart(products)}><span className="fa fa-times-circle"></span> Remove
                      </button>
                    </li>
                  </div>
                  )}
          ...
          <div className="col-md-8 order-md-1">
            <h4 className="mb-3">Alamat tujuan : </h4>
